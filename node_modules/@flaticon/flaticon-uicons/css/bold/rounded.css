@font-face {
    ...
    src: url(../uicons-bold-rounded-W6H725OC.woff2) format("woff2"),
      url(../uicons-bold-rounded-Z2ZCAXVC.woff) format("woff"),
      url(../uicons-bold-rounded-LNV3TFSZ.eot#iefix) format("embedded-opentype");
    font-display: swap;
  }

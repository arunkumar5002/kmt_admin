...
class Company extends CI_Controller
{
	...
	public function savecompanymaster(){
     ...
     //  print_r($_POST);		
		 if($company_id == ''){
		   $this->company_model->save_companymaster($name,$email,$landline,$mobile, $address,$source,$website);
		$this->session->set_flashdata("message","Created successfully.");
		}else{
			$this->company_model->update_campanymaster($name,$email,$landline,$mobile, $address,$source,$website,$company_id);
